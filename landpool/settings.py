"""
Django settings for landpool project.
...
SECRET_KEY = 'django-insecure-8=56y(p4!vvb4bls0dishy-*$tiitk)xcu6!=-*!)hs+)4g=+-'
...
WSGI_APPLICATION = 'landpool.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'landpool/static')
]

LEAFLET_CONFIG = {
    'DEFAULT_CENTER': (28.1392,83.85335),
    'DEFAULT_ZOOM': 18,
    'MIN_ZOOM': 3,
    'MAX_ZOOM': 20,
    'SCALE': 'both',
    'ATTRIBUTION_PRIFIX': 'Land Pooling',
    'RESET_VIEW': False,
